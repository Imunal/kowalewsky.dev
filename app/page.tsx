import { Spacer, Projects } from "components";
        ...
        <div className="flex flex-col items-start border-gray-200 dark:border-gray-700">
          <div className="py-20">
            ...
            <p className="mb-2 text-lg text-gray-700 dark:text-gray-200">
              Aktualnie pracuje jako Full-Stack Developer w{" "}
              <b>Fototransfer.pl</b>
            </p>

            <div className="mt-3 grid grid-cols-1 gap-1 text-gray-700 dark:text-gray-200 md:grid-cols-3">
              <div>
                <svg
